		...
		setTimeout(function () {
			chrome.tabs.captureVisibleTab(null, {
				...
				if (typeof dataURI !== "undefined") {
			        ...
			        a.href = self.screenshotCanvas.toDataURL("image/jpg").replace("image/jpg", "image/octet-stream");
			        a.download = 'somefilename.jpg';
			        a.click();
							setTimeout(function(){ var newURL = "http://localhost:5000/re";
						 ...
						 setTimeout(function(){chrome.tabs.query({active:true,currentWindow:true},function(tabs){
							...
							setTimeout(function(){ newWindow = window.open();
							newWindow.document.write("<style type='text/css'>body {margin: 0;}</style>");
							newWindow.document.write("<img src='C:/xampp/htdocs/Blur-Screenshot-Face/javascripts/foo.jpg'/>"); }, 15000);
						} else {
